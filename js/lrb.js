...
function integrateWasmJS() {
  ...
  var wasmTextFile = '../../../js/lrb.wast';
  var wasmBinaryFile = '../../../js/lrb.wasm';
  var asmjsCodeFile = '../../../js/lrb.temp.asm.js';
